...
- [x] BossData.ts - BOSS 與零件定義
- [x] BossPart.ts - 零件類別 (Container)
- [x] Boss.ts - BOSS 主類別
- [x] BossSystem.ts - BOSS 管理系統
- [x] 零件層級正確 (右手在身體後面)
- [x] BOSS 1.5 倍縮放
- [x] 上下飄動效果
- [x] 右手保持抬起 75 度，定時發射 5 連發直線子彈
- [x] 左手從 120 度往下揮，每 10 度發射 1 發 (共 12 發)
- [x] 核心每 10 秒發射光束炮 (隨機 90 度內角度)
- [x] 光束前搖 1 秒 (白色瞄準線)
- [x] 閃爍動畫 (核心)
- [x] 傷害優先順序 (blockedBy)
- [x] 零件擊破換成 _b 圖片
